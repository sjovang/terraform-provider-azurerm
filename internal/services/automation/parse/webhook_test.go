...
var _ resourceids.Id = WebhookId{}

func TestWebhookIDFormatter(t *testing.T) {
	actual := NewWebhookID("12345678-1234-9876-4563-123456789012", "group1", "account1", "webhook1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/webHooks/webhook1"
	if actual != expected {
...
func TestWebhookID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/webHooks/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/webHooks/webhook1",
			Expected: &WebhookId{
