...
var _ resourceids.Id = CredentialId{}

func TestCredentialIDFormatter(t *testing.T) {
	actual := NewCredentialID("12345678-1234-9876-4563-123456789012", "group1", "account1", "cred1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/credentials/cred1"
	if actual != expected {
...
func TestCredentialID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/credentials/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/credentials/cred1",
			Expected: &CredentialId{
	...
	for _, v := range testData {
		...
		actual, err := CredentialID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
