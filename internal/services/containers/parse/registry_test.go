...
var _ resourceids.Id = RegistryId{}

func TestRegistryIDFormatter(t *testing.T) {
	actual := NewRegistryID("12345678-1234-9876-4563-123456789012", "group1", "registry1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.ContainerRegistry/registries/registry1"
	if actual != expected {
