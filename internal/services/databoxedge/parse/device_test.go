...
var _ resourceids.Id = DeviceId{}

func TestDeviceIDFormatter(t *testing.T) {
	actual := NewDeviceID("12345678-1234-9876-4563-123456789012", "resGroup1", "device1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/device1"
	if actual != expected {
