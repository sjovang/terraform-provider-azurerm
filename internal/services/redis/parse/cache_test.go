...
var _ resourceids.Id = CacheId{}

func TestCacheIDFormatter(t *testing.T) {
	actual := NewCacheID("12345678-1234-9876-4563-123456789012", "resGroup1", "redis1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cache/Redis/redis1"
	if actual != expected {
